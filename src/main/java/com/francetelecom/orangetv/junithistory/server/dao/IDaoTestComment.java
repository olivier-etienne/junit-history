...
public interface IDaoTestComment extends IDao {
	...
	public final static MessageFormat MF_CREATE_COMMENT = new MessageFormat(INSERT + TABLE_NAME + " ("
			...
			+ " {3, number, ####} , " // testId ...
			+ " {4, number, ####} ," // userId...
			+ " {5, number, ##########}, " // date creation...
			+ " {6, number, ##########} " // date modification...
			+ ");"); // ...
	...
	// UPDATE COMMENT
	// =============================================
	public final static MessageFormat MF_UPDATE_COMMENT = new MessageFormat(UPDATE + TABLE_NAME + " " + SET // ...
			+ DB_TITLE + " = ''{0}'', " // ...
			+ DB_DESC + " = ''{1}'', " // ...
			+ DB_USER_ID + " = {2, number, ####}, " // ...
			+ DB_DATE_MODIF + " = {3, number, ##########} " // ...
